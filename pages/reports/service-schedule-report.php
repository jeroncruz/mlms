...
<html lang="en">
  <head>
    ...
    <title>MLMS-Service Schedule </title>
                                    ...
                                    <button type = 'button' class = 'btn btn-primary' onClick="window.open('../report-pdf/scheduling-report-daily.php')">
                                        ...
                                        <div class="table-responsive col-md-12 col-lg-12 col-xs-12">
                                             <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Date Scheduled</th>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Time Scheduled</th>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Customer Name</th>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Deceased Name</th>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Unit Location</th>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Unit Type</th>
                                                            <th class = "success" style = "text-align: center; font-size: 14px;">Price</th> 
