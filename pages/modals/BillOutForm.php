...
<!----------------------------------------------BILL OUT FORM---------------------------------->
<div class="modal fade" id="modalBill" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="z-index: 1500;display:none;">
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <div class="col-md-6 col-sm-9 col-xs-12">
                                            <select class="form-control" id="typeAvail" onchange="changeAvail(this.value)">
                                              <option selected disabled>Type of Availment:</option>
								...
								<div class="panel-heading">
									<form class="form-vertical" id="formCustomer" role="form" action="reserver.php" method="POST">
										<div class="form-group">
											...
											<input type="button" onclick="actionAddCustomer()" id="btnAddCustomer" class="btn btn-success col-md-3"  name="btnAdd" value="ADD CUSTOMER"/>
											<button type="button" id="btnUpdateCustomer" class="btn btn-success col-md-3" name="btnUpdate" style="display:none;">UPDATE CUSTOMER</button>
										</div>
								...
								<div class="panel-body">
										<div class="row">
											<div class="form-group">
												<div class="col-md-4" style="margin-top:.30em">
													First Name:
													<input type="text" class="form-control input-md" id= "tfFirstName" name="tfFirstName" placeholder="First Name" required>
												</div>
												
												<div class="col-md-4" style="margin-top:.30em">
													Middle Name:
													<input type="text" class="form-control input-md" id= "tfMiddleName" name="tfMiddleName" placeholder="Middle Name" >
												</div>
												
												<div class="col-md-4" style="margin-top:.30em">
													Last Name:
													<input type="text" class="form-control input-md" id= "tfLastName" name="tfLastName" placeholder="Last Name" required>
												</div>
											</div>
										...
										<div class="row">
											<div class="form-group">
												<div class="col-md-4" style="margin-top:.30em">
													Address:
													<input type="text" class="form-control input-md" id= "tfAddress" name="tfAddress" placeholder="Address" required>
												</div>

												<div class="col-md-4" style="margin-top:.30em">
													Contact No:
													<input type="text" class="form-control" required id= "tfContactNo" name="tfContactNo" data-inputmask="'mask' : '(9999) 999-9999'">
												</div>
												
												<div class="col-md-4" style="margin-top:.30em">
													Date of Birth:
													<input type="date" class="form-control input-md" id= "tfDate" name="tfDate" >
												</div>
											</div>
										...
										<div class="row">
											<div class="form-group">
												<div class="col-md-4" style="margin-top:.30em">
													Email Address:
													<input type="email" class="form-control input-md" id= "tfEmail" name="tfEmail" placeholder="Email Address" required>
												</div>
												
												<div class="col-md-4" style="margin-top: 30px;">
													<input type="number" name="intGender" id="intGender" hidden />
													Gender:
													<input type="radio"  align="right" class="flat form-control input-md" id="radioMale" name="gender" value='0'> MALE
													<input type="radio" align="right" class="flat form-control input-md"  id="radioFemale" name="gender" value='1'>FEMALE
												</div>
												
												<div class="col-md-4" style="margin-top:30px;">
													<input type="number" name="intCivilStatus" id="intCivilStatus" hidden />
													Civil Status:
