                                    ...
                                    <div class="panel panel-success ">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" role="form" action = "interest.php" method= "post">
                                                ...
                                                <div class='form-group'>
                                                    <label class="col-md-5" style = " font-size: 18px;" align="right" style="margin-top:.30em">At Need:</label>
                                                    <div class="col-md-7">
                                                        <div class='input-group'>
                                                            <input type='text' class='form-control input-md' name= 'tfAtNeed' onkeypress='return validateNumber(event)' required/>
                                                ...
                                                <div class='form-group'>
                                                    <label class="col-md-5" style = " font-size: 18px;" align="right" style="margin-top:.30em">Regular:</label>
                                                    <div class="col-md-7">
                                                        <div class='input-group'>
                                                            <input type='text' class='form-control input-md' name= 'tfRegular' onkeypress='return validateNumber(event)' required/>
                                                            <span class = 'input-group-addon'>%</span>
                                                        </div>
                                                    </div> 
                                                </div>
                                                ...
                                                <div class="form-group modal-footer">
                                                    <div class="col-md-12 col-md-offset-4">
                                                        <button type="submit" class="btn btn-success col-md-3" name= "btnSubmit">Create</button>
                                                        <input class = "btn btn-default col-md-5" type="reset" name = "btnClear" value = "Clear Entries">
                                                    </div>
                                                    <h4 class="col-md-12" style = "color: red; margin-top:.30em" align="left">REQUIRED ALL FIELDS</h4>
                                                </div>
                                        </form><!--Form-->
