                ...
                <ul class="nav side-menu">
                    ...
                    <li style="font-size: 20px"><a><i class="fa fa-list"></i> Queries <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <li><a href = "qlot-query.php" style="font-size: 12px">LOT-UNIT</a></li>
                            <li class = "divider"></li>
                            <li>ASH CRYPT</li>
                    ...
                    <li style="font-size: 20px"><a><i class="fa fa-list-alt"></i> Reports <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                                 ...
                                 <li><a href = "../reports/cancelled-reservation-report.php" style="font-size: 12px">Cancelation of Reserve</a></li>
                                 <li><a href = "../reports/installment-report.php" style="font-size: 12px">Installment</a></li>
                                 <li><a href = "../reports/service-request-report.php" style="font-size: 12px">Services</a></li>
                        </ul>
                    </li>
