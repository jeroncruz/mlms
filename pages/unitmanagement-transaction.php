                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-4" style="margin-top: 30px;">
                                              Gender:
                                              <input type="radio"  align="right" class="flat form-control input-md" name="gender"> M
                                              <input type="radio" align="right" class="flat form-control input-md" name="gender">F
                                            </div>
