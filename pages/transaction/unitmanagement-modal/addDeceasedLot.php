                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4" style="margin-top:.30em">
                                                <span style="color:red;">*</span>
                                                Age:
                                                <input type="text" class="form-control input-md" id= "age<?php echo $intAvailUnitId ?>" placeholder="Age" readonly>
                                            </div>
                                        </div>
                                    </div><!--ROW-->
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                    ...
                                                    <input type='hidden' class='form-control input-md' id="service<?php echo $intAvailUnitId ?>" name = "" value='<?php echo $intServiceID ?>' readonly/>
                                        ...
                                        <div class='form-group col-md-offset-7'> 
                                            <button type='submit' id="submit<?php echo $intAvailUnitId ?>" class='btn btn-success' name= 'btnSubmitDeceasedLot'>Submit</button>
