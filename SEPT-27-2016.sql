...
CREATE TABLE `tblavailunit` (
  ...
  `deciAmountPaid` decimal(10,2) NOT NULL,
...
INSERT INTO `tblavailunit` VALUES (12,13,11,'2016-09-24','Spotcash',18000000.00,NULL,NULL,NULL,NULL),(14,14,11,'2016-09-25','Reserve',25000.00,1,7,6000000.00,'2016-09-30'),(15,14,11,'2016-09-25','Reserve',24000.00,1,7,6000000.00,'2016-09-30'),(16,14,11,'2016-09-25','Reserve',25000.00,1,8,6000000.00,'2016-09-30'),(17,14,11,'2016-09-25','Reserve',30000.00,1,7,6000000.00,'2016-09-30'),(18,14,11,'2016-09-25','Reserve',25000.00,1,7,6000000.00,'2016-09-30'),(19,14,11,'2016-09-25','Reserve',25000.00,1,7,6000000.00,'2016-09-30'),(20,14,11,'2016-09-25','Reserve',25000.00,1,7,6000000.00,'2016-09-30'),(21,14,11,'2016-09-26','At-Need',25000.00,1,8,6000000.00,'2016-10-01'),(22,14,11,'2016-09-26','Reserve',24000.00,1,7,6000000.00,'2016-10-01'),(23,14,11,'2016-09-26','At-Need',24000.00,1,7,6000000.00,'2016-10-01');
...
CREATE TABLE `tblavailunitash` (
  ...
  `intStatus` int(11) DEFAULT NULL,
  `intInterestId` int(11) DEFAULT NULL,
  `deciDownpayment` decimal(8,2) DEFAULT NULL,
  `datDueDate` date DEFAULT NULL,
...
INSERT INTO `tblavailunitash` VALUES (1,5,11,'2016-09-26','Spotcash',10000.00,NULL,NULL,NULL,NULL),(2,6,11,'2016-09-26','Reserve',1000.00,1,7,3000.00,'2016-10-01'),(3,5,11,'2016-09-26','Reserve',2000.00,0,7,3000.00,'2016-10-01'),(4,6,11,'2016-09-26','Reserve',1000.00,1,7,3000.00,'2016-10-01'),(5,5,11,'2016-09-26','At-Need',1000.00,1,7,3000.00,'2016-10-01');
...
INSERT INTO `tblcustomer` VALUES (11,'Karl','','O\'hara','Mandaluyong','09090909090','2001-08-08',0,0);
...
INSERT INTO `tbllot` VALUES (13,'A0001',2,0,13,NULL),(14,'A0002',0,0,13,NULL);
...
INSERT INTO `tblservicerequirement` VALUES (20,48,5),(21,48,4);
...
INSERT INTO `tbltypeoflot` VALUES (4,'Junior Estate',24,20000000.00,0);
...
-- Dump completed on 2016-09-27  2:42:56
